		...
		if (winner != null)
                {
                   ...
                   System.out.println("Count of pruning:"+MinimaxTTTAgent.c);
                   System.out.println("Branch:"+MinimaxTTTAgent.count);
                   //  System.out.println("Loopcount of SolutionInfo is:"+loopCount);
                }
		else	{
