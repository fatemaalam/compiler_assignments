...
public class KakuroForm2Book1P1 extends JFrame{
    public static  Model model = new Model("my first kakuro problem Formulation2 Book 1 problem 1");
// 2. Create variables
...
// 4. Solve the problem
    ...
    solver.findSolution();
    new KakuroForm2Book1P1().setVisible(true);
...
- Solution #1 found. Model[my first kakuro problem], 1 Solutions, Resolution time 0.088s, 2 Nodes (22.8 n/s), 0 Backtracks, 0 Fails, 0 Restarts 
