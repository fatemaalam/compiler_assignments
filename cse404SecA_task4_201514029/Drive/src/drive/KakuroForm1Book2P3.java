...
public class KakuroForm1Book2P3 extends JFrame{
    
 public static  Model model = new Model("my third kakuro problem Formulation1 Book 2 problem 3");
// 2. Create variables
...
// 4. Solve the problem
    ...
    solver.findSolution();
    new KakuroForm1Book2P3().setVisible(true);
...
- Solution #1 found. Model[my third kakuro problem], 1 Solutions, Resolution time 0.042s, 3 Nodes (72.1 n/s), 1 Backtracks, 1 Fails, 0 Restarts 
