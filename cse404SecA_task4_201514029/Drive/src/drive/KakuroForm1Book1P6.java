...
public class KakuroForm1Book1P6 extends JFrame{
    
 public static  Model model = new Model("my second kakuro problem Formulation1 Book 1 problem 6");
// 2. Create variables
...
// 1. Create a Model
//Model model = new Model("my second kakuro problem");
// 2. Create variables
...
// 4. Solve the problem
    ...
    solver.findSolution();
    new KakuroForm1Book1P6().setVisible(true);
...
- Solution #1 found. Model[my second kakuro problem], 1 Solutions, Resolution time 0.097s, 6 Nodes (61.6 n/s), 1 Backtracks, 1 Fails, 0 Restarts 
